...
secrethub run -- terraform output DPSSimpleServiceAccount_aws_access_key_id | secrethub write twdps/di/svc/aws/dps-1/DPSSimpleServiceAccount/aws-access-key-id
