...
secrethub run -- terraform output DPSSimpleServiceAccount_aws_access_key_id | base64 --decode | gpg -dq --passphrase {{ twdps/di/svc/gpg/passphrase }} | secrethub write twdps/di/svc/aws/dps-1/DPSSimpleServiceAccount/aws-access-key-id
