{
  ...
  "aws_account_id": "{{ op://cohorts/alpha-aws/aws-account-id }}",

  "aws_region": "us-east-2",
  "assume_role": "DPSIamProfilesRole",
  "account_id": "{{ op://cohorts/alpha-aws/aws-account-id }}",
  "nonprod_account_id": "{{ op://cohorts/alpha-aws/aws-account-id }}",
